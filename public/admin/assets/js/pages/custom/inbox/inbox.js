    ...
    var _initForm = function(formEl) {
        ...
        var tagifyTo = new Tagify(toEl, {
            ...
            whitelist: [{
                ...
                initials: '',
                initialsState: '',
                pic: './admin/assets/media/users/100_11.jpg',
                ...
                initials: '',
                initialsState: '',
                pic: './admin/assets/media/users/100_6.jpg'
            }, {
                value: 'Sam Seanic',
                email: 'sam.senic@loop.com',
                initials: '',
                initialsState: '',
                pic: './admin/assets/media/users/100_8.jpg'
            }, {
                value: 'Sara Loran',
                email: 'sara.loran@tilda.com',
                initials: '',
                initialsState: '',
                pic: './admin/assets/media/users/100_9.jpg'
            }, {
                value: 'Eric Davok',
                email: 'davok@mix.com',
                initials: '',
                initialsState: '',
                pic: './admin/assets/media/users/100_13.jpg'
            }, {
                value: 'Sam Seanic',
                email: 'sam.senic@loop.com',
                initials: '',
                ...
                pic: './admin/assets/media/users/100_15.jpg'
            }],
            templates: {
