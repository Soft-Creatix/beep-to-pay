                    ...
                    <form method="POST" action="{{ route('website.login') }}" id="loginForm">
                        ...
                        <div class="form-group">
                            <input type="email" name="email" value="{{ old('email') }}" class="form-control input-field"
                                placeholder="Email or Phone Number" data-rule-required="true" data-rule-email="true"
                                data-msg-required="Please enter your email address"
                                data-msg-email="Please enter a valid email address" />
                        </div>
                        <div class="form-group position-relative">
                            <input type="password" id="password" name="password" value="{{ old('password') }}"
                                class="form-control input-field" placeholder="Password" data-rule-required="true"
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="flex-fill bd-highlight text-right">
                                    <a href="{{ route('password.request') }}"
                                        class="font_14 royal-blue font-weight-bold">Forgot password?</a>
                                </div>
                            </div>
                        </div>
