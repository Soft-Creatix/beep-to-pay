                            ...
                            <tbody>
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td>{{ $role->name }}</td>
                                        <td nowrap="nowrap">
                                            <form action="{{ route('role.destroy', $role->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                                                <a class="btn btn-primary" href="{{ route('role.edit', $role->id) }}"><i class="flaticon-edit"></i> Edit</a>
                                                @csrf
                                                @method('DELETE')
