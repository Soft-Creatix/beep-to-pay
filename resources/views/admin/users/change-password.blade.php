                        ...
                        <form action="{{ route('user.password.update') }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('current_password') is-invalid @enderror" placeholder="Enter password..." name="current_password" id="current_password" required />
